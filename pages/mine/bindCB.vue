    ...
    <div class="ui-content">
      ...
      <div class="ui-content-auto">
        <div class="setting-box">
          <div class="setting-box-title">CBPAY提现地址</div>
          <div class="setting-box-subtitle">请设置你的CBPAY提现地址</div>
          <div class="setting-item">
            ...
            <div class="setting-item">
              <div class="setting-item-title">CBPAY提现地址</div>
              <div class="setting-item-content">
                <input v-model="form.cbUrl" placeholder="请输入CBPAY提现地址" />
              </div>
            </div>
          </div>
        </div>
...
const form = reactive({
  code: '',
  cbUrl: userStore.userInfo.cbRemark,
})
...
const handleSubmit = async () => {
  ...
  if (!form.cbUrl) {
    return $message.error('请输入CBPAY提现地址')
  }
  try {
    await $request.post('/prod-api/home/user/cbu', {
      phoneCode: form.code,
      cbRemark: form.cbUrl,
      uRemark: userStore.userInfo.uRemark,
    })
